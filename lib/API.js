...
export default class API {
  ...
  updateURL() {
    ...
    this.currentURL = `http://api.wunderground.com/api/49c6b5a2b723a2be/conditions/q/${this.location}`
    this.currentHighLowURL = `http://api.wunderground.com/api/49c6b5a2b723a2be/forecast/q/${this.location}`
    this.tenDayURL = `http://api.wunderground.com/api/49c6b5a2b723a2be/forecast10day/q/${this.location}`
    this.sevenHourURL = `http://api.wunderground.com/api/49c6b5a2b723a2be/hourly/q/${this.location}`
  }
