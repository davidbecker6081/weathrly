...
export default class API {
  ...
  updateURL() {
    ...
    this.currentURL = `http://api.wunderground.com/api/249b0f95aae3c961/conditions/q/${this.location}`
    this.currentHighLowURL = `http://api.wunderground.com/api/249b0f95aae3c961/forecast/q/${this.location}`
    this.tenDayURL = `http://api.wunderground.com/api/249b0f95aae3c961/forecast10day/q/${this.location}`
    this.sevenHourURL = `http://api.wunderground.com/api/249b0f95aae3c961/hourly/q/${this.location}`
  }
